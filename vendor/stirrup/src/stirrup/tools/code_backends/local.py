        ...
        for source in paths:
            ...
            try:
                if source.is_file():
                    ...
                    # Offload the blocking copy to a thread: at high concurrency
                    # many sessions enter at once and a sync copy here would freeze
                    # the event loop, serializing every other in-flight unit.
                    ...
                    if dest_dir:
                        ...
                        for item in source.iterdir():
                            ...
                            if item.is_file():
                                await asyncio.to_thread(shutil.copy2, item, item_dest)
                            else:
