...
def _normalize_finish_tools[FinishParams: BaseModel, FinishMeta](
    ...
    if finish_tool is None:
        ...
        if not finish_tool:
            # Empty list means no finish tools — agent terminates on natural completion
            return {}
...
class Agent[FinishParams: BaseModel, FinishMeta]:
    ...
    def __init__(
        ...
        *,
        ...
        passthrough_system_prompt: bool = ...,
    ...
    def __init__(
        ...
        *,
        ...
        passthrough_system_prompt: bool = False,
        # Logging
        ...
        Args:
            ...
            passthrough_system_prompt: If True, return system_prompt directly without
                                       wrapping in the base system prompt template.
                                       Defaults to False.
        ...
        self._passthrough_system_prompt = passthrough_system_prompt
    ...
    def _build_system_prompt(self) -> str:
        ...
        """
        # If passthrough_system_prompt is set and a custom system_prompt is provided,
        # use it directly without wrapping in the base prompt template.
        if self._passthrough_system_prompt and self._system_prompt:
